...
if answer == "left":
    ...
    answer = input("You come to bridge, it looks broken do you want to cross it or head back (cross/back)? ").lower()
    if answer == "back":
        ...
        if answer == "yes":
            print("You talked to stranger and they give you a treasure map. You WIN!!!")
        elif answer == "no":
